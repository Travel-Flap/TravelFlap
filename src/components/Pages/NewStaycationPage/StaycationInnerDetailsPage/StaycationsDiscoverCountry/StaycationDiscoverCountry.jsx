...
import "./StaycationsDiscoverCountry.css";
...
import { StaycationDiscoverCountryFaq } from './StaycationDiscoverCountryFaq';

export const StaycationsDiscoverCountry = () => {
    ...
    return (
        <div className='hotelInnerDiscoverCountryOuterDiv'>

            <div class="hotelInnerDiscoverMaincarddiv card text-bg-dark">
                {/* <img src="Images/NewHomeLayout/BackgroundImages/TopCitiesBackground.jpeg" class="card-img" alt="..." /> */}
                <div className='hotelInnerDiscoverBelowDiv'>

                </div>
                <div class="card-img-overlay ">
                    <div className='hotelInnerDiscoverMainheading'>

                        <div className='hotelInnerDiscoverHeadingouterdiv'>
                            <h2> Discover Country Stays </h2>

                            <div id='hotelInnerDiscoverDropContainer'>
                                <select id="hotelInnerDiscoverCountrydrop" onChange={(e) => handlecounty(e)}
                                ...
                                <div id='hotelInnerDiscoverIcondiv'>
                                    <FaAngleDown size={"1em"} id="hotelInnerDiscoverIcon" />
                                </div>
                            </div>

                        </div>

                        <div className='hotelInnerDiscoverSliderContainer'>
                            {/* From here the next slider part starts */}

                            <div className='hotelInnerDiscoverSlickslidercontainer'>
                                <SliderWrapper>
                                    <Slider {...settings} className="multiCardSlider">
                                        <div className="card-wrapper">
                                            <div className="card hotelInnerDiscoverDiv">
                                                <div className="card-image hotelInnerDiscoverCardimage">
                                                    <img src="Images/NewHomeLayout/Hotels/AllCompImages/Rambagh Hotel.jpg" />
                                                </div>
                                                <div className="hotelInnerDiscoverDetails">
                                                    <h2> Rambagh Hotel
                                                        {/* <span> */}
