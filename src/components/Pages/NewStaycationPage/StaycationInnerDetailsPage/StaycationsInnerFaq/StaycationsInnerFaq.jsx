...
import "./StaycationsInnerFaq.css";

export const StaycationsInnerFaq = () => {
  return (

    <>
      <div className='hotelInnerFaqOuterDiv'>
        <div className='hotelInnerFaqHeading'>
          <h2>FAQ</h2>
        </div>

        <div className='hotelInnerPageFaq'>
          <Accordion defaultActiveKey="">
            <Accordion.Item className='statedop1' eventKey="0">
              <Accordion.Header className='statedrop1header hotelInnerFaqInnerHeading'>What are advantages of  online Flight booking ?</Accordion.Header>
              <Accordion.Body className='statedroptexts hotelInnerFaqInnerTexts'>
