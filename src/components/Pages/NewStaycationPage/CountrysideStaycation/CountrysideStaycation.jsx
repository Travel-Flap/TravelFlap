...
import "./CountrysideStaycation.css";
...
export const CountrysideStaycation = () => {
    ...
    return (
        <div className="newCountrysideStaycationmaindiv">
            {/* <h1>Ipl</h1> */}


            <div className="bestCountrysideStaycationHeadingcontainer" >
                <div className="cardtextFavStaycationDropbutton">
                    {/* <CountryDropHotel /> */}
                    <h2>Countryside Staycations</h2>
                ...
                <div className='newFavStaycationDotsdiv'>
                    ...
                    >
                        ...
                        <div className="cardtextFavStaycation_maindiv">
                            ...
                            <img src="Images/NewHomeLayout/NewStaycations/SliderImages/jaipur.png" alt="" />
                        ...
                        <div className="cardtextFavStaycation_maindiv">
                            ...
                            <img src="Images/NewHomeLayout/NewStaycations/SliderImages/almora range.png" alt="" />
                            <div className="cardFavStaycation_title">
                                <h5>
                                    Almora Range,India
                                </h5>
                        ...
                        <div className="cardtextFavStaycation_maindiv">
                            ...
                            <img src="Images/NewHomeLayout/NewStaycations/SliderImages/jagalbet.png" alt="" />
                            <div className="cardFavStaycation_title">
                                <h5>
                                    Jagalbet,India
                                </h5>
                        ...
                        <div className="cardtextFavStaycation_maindiv">
                            ...
                            <img src="Images/NewHomeLayout/NewStaycations/SliderImages/baindur.png" alt="" />
                            <div className="cardFavStaycation_title">
                                <h5>
                                    Baindpur, India
                                </h5>
