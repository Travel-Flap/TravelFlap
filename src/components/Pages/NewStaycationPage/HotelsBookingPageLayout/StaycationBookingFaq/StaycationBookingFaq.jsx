...
import "./StaycationBokingFaq.css";

export const StaycationsBookingFaq = () => {
  return (
    <div className='StaycationsBookingFaqContainer'>
      <h3> FAQ </h3>
      <div className='StaycationsBookingFaqMainDiv'>
        <Accordion defaultActiveKey="0">
          <Accordion.Item className='statedop1' eventKey="">
            <Accordion.Header className='StaycationsBoookingFaqheader'>What are advantages of  online Flight booking ?</Accordion.Header>
            <Accordion.Body className='StaycationsBookingFaqtexts'>
