...
import "./HotelBokingFaq.css";

export const HotelBookingFaq = () => {
  return (
    <div className='hotelBookingFaqContainer'>
      <h3> FAQ </h3>
      <div className='hotelBookingFaqMainDiv'>
        <Accordion defaultActiveKey="0">
          <Accordion.Item className='statedop1' eventKey="">
            <Accordion.Header className='hotelBoookingFaqheader'>What are advantages of  online Flight booking ?</Accordion.Header>
            <Accordion.Body className='hotelBookingFaqtexts'>
