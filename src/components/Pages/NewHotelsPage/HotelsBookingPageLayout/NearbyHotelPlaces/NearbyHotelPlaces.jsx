...
export const NearbyHotelPlaces = () => {
                ...
                <div class="card-img-overlay ">
                    <div className='newVarietyOfStaysMainheading'>
                        ...
                        <div className='newVarietyOfStaysHeadingouterdiv'>
                            <h2> Nearby Hotel Places to Stays</h2>
                        ...
                        <div className='varietyButtonsSelector'>
                            <div class="btn-group varietyButtonMainDiv" role="group" aria-label="Basic radio toggle button group">
                                ...
                                <label class="btn btn-outline-primary varietyButton1" for="btnradio">Mountain Hotel</label>

                                <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off" />
                                <label class="btn btn-outline-primary varietyButton2" for="btnradio"> Dessert Hotel </label>

                                <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off" />
                                <label class="btn btn-outline-primary varietyButton3" for="btnradio"> Camping Site </label>

                                <input type="radio" class="btn-check" name="btnradio" id="btnradio4" autocomplete="off" />
                                <label class="btn btn-outline-primary varietyButton4" for="btnradio"> Lake Front Hotel </label>

                                <input type="radio" class="btn-check" name="btnradio" id="btnradio4" autocomplete="off" />
                                <label class="btn btn-outline-primary varietyButton5" for="btnradio"> Beach Hotel </label>
                            </div>
                        </div>
