...
<div className='test'>
    test
        ...
        <div className= {showtab===5? "test active": "test" } onClick={()=>handletab(5)}>
            BTN 1
        </div>
        <div className= {showtab===2? "test active": "test" }  onClick={()=>handletab(2)}>
            BTN 2
        </div>
        <React.Fragment>
             <Container>
      ...
      <h3 className="mt-3 mb-3">Show Hide Div Content on button click in React js </h3>
       ...
       <ul class="nav nav-pills mb-3 mt-1" id="pills-tab" role="tablist">
          ...
          <button className= {showtab===1? "nav-link active": "nav-link" }  onClick={()=>handletab(1)} style={{color:"black"}}>Home</button>
          </li>
          <li class="nav-item" role="presentation">
      ...
      <div class="tab-content text-dark" id="pills-tabContent">
        ...
        <div className='innerVisaChangeableDataMainDiv'>
