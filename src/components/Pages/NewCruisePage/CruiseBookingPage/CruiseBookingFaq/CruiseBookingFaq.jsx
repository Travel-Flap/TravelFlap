...
import "./CruiseBokingFaq.css";

export const CruiseBookingFaq = () => {
  return (
    <div className='cruiseBookingBookingFaqContainer'>
      <h3> FAQ </h3>
      <div className='cruiseBookingBookingFaqMainDiv'>
        <Accordion defaultActiveKey="0">
          <Accordion.Item className='statedop1' eventKey="">
            <Accordion.Header className='cruiseBookingBoookingFaqheader'>What are advantages of  online Flight booking ?</Accordion.Header>
            <Accordion.Body className='cruiseBookingBookingFaqtexts'>
