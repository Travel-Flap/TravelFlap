...
export const DomesticCruise = () => {
    ...
    return (
        <>
            <div className="trendingcruiseoutercontainer" style={{backgroundColor:"#3380F2"}}>
                <div className="newTrendingCruiseHeadingContainer">
                    <h2 className="trendingcruisenewhomepageheading" style={{color:"white"}}>Domestic Cruise</h2>
                   <div className='newTrendingCruiseDropContainer'>
                        <select className="form-select domesticCruiseCountryDrop"  onChange={(e) => handlecounty(e)}
                        ...
                        <div className='domesticCruiseicondiv'>
                        <FaAngleRight style={{fontSize:"15px"}} size={"1em"} className="domesticCruiseicon" />
                        </div>
                    </div>
