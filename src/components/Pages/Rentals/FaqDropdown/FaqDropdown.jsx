    ...
    return (
        <>
            <div className='faq_maincontainer'>
                <div className='accordion_dropdownmaincontainer1'>
                ...
                <div className='accordion_dropdownmaincontainer2'>
                    <h2 className='faq_heading'>
                    ...
                    <Accordion>
                        ...
                        <Accordion.Item eventKey="1">
                            <Accordion.Header>How much does it cost to hire a car in India?</Accordion.Header>
                            <Accordion.Body>
