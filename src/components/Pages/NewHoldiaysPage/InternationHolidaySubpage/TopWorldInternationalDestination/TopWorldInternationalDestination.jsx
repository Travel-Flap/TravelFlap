...
import "./TopWorldInternationalDestination.css";
// import { ButtonBase } from "@material-ui/core";
import { Button } from "react-bootstrap"
import { FaAngleLeft, FaAngleRight } from 'react-icons/fa';

export const InternationalSubpageWorldTop = () => {
    ...
    return (
        <div className="newDomesticWorldTopmaindiv">
            ...
            <div className="newDomesticWorldTopHeadingcontainer" >
                <h2 className="newDomesticWorldTopHeading1">Top of the world International Destinations</h2>
