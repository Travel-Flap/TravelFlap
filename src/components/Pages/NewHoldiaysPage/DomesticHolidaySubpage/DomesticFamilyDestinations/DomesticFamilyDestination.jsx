...
import "./DomesticFamilyDestinations.css";
// import { ButtonBase } from "@material-ui/core";
import { Button } from "react-bootstrap"
import { FaAngleLeft, FaAngleRight } from 'react-icons/fa';

export const DomesticFamilyDestinations = () => {
    ...
    return (
        <div className="newDomesticFamilyDestinationmaindiv">
            ...
            <div className="newDomesticFamilyDestinationHeadingcontainer" >
                <h2 className="newDomesticFamilyDestinationHeading1">Domestic Family Destinations</h2>
