// export const NewPopularCarHireDestination = () => {
    // export const DomesticHoneyMoonDestination = () => {
...
import "./DomesticHoneymoonDestination.css";
    ...
    return (
        <div className="newDomesticFamilyDestinationmaindiv">
            ...
            <div className="newDomesticFamilyDestinationHeadingcontainer" >
                <h2 className="newDomesticFamilyDestinationHeading1">Domestic Honeymoon Destinations</h2>
