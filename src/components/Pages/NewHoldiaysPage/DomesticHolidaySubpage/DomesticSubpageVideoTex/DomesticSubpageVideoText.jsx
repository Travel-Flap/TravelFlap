import "./DomesticSubpageVideoText.css";
import Image from "./m_Interlaken_l_426_640.jpg";

export const VideoTextDomesticSubpage = () => {
    var embedId = "JQr1-VchonU"
    return (
        <>
            {/* <div className="Main-Content-Footer"> */}
            
            <div className="domesticSubpage-Content-Footer">
                <img src={Image} />
            </div>
            <div className="domesticSubpage-Content-Items">
                <iframe
                    width="650"
                    height="400"
            ...
            <div className="domesticSubpage-Content-Footer3">
                {/* <h3> Take a tour</h3> */}
