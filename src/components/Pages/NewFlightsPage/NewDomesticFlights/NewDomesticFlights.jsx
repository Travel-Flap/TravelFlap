...
export const NewDomesticFlightsNearYou = () => {
    ...
    return (
        <div className="newFlightDomesticmaindiv">
            {/* <h1>Ipl</h1> */}


            <div className="bestFlightDomesticHeadingcontainer" >
                <div className="cardtextDomesticFlightdropbutton">
                    {/* <CountryDropHotel /> */}
                    <h2>Domestic Flights Near You</h2>
                    <div className='newFlightDomesticDropContainer'>
